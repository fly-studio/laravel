...
class RoleTest extends TestCase
{
    ...
    public function testAttachPermission()
    {
        ...
        */
        ...
        |------------------------------------------------------------
        */
        $this->assertInstanceOf('Addons\Entrust\Tests\Models\Role', $this->role->attachPermission($permA));
        $this->assertCount(1, $this->role->permissions()->get()->toArray());

        $this->assertInstanceOf('Addons\Entrust\Tests\Models\Role', $this->role->attachPermission($permB->toArray()));
        $this->assertCount(2, $this->role->permissions()->get()->toArray());

        $this->assertInstanceOf('Addons\Entrust\Tests\Models\Role', $this->role->attachPermission($permC->id));
    ...
    public function testDetachPermission()
    {
        ...
        */
        ...
        |------------------------------------------------------------
        */
        $this->assertInstanceOf('Addons\Entrust\Tests\Models\Role', $this->role->detachPermission($permA));
        $this->assertCount(2, $this->role->permissions()->get()->toArray());

        $this->assertInstanceOf('Addons\Entrust\Tests\Models\Role', $this->role->detachPermission($permB->toArray()));
        $this->assertCount(1, $this->role->permissions()->get()->toArray());

        $this->assertInstanceOf('Addons\Entrust\Tests\Models\Role', $this->role->detachPermission($permB->id));
        $this->assertCount(1, $this->role->permissions()->get()->toArray());
    }
    ...
    public function testAttachPermissions()
    {
        ...
        */
        ...
        |------------------------------------------------------------
        */
        $this->assertInstanceOf('Addons\Entrust\Tests\Models\Role', $this->role->attachPermissions($perms));
        $this->assertCount(3, $this->role->permissions()->get()->toArray());
    }
    ...
    public function testDetachPermissions()
    {
        ...
        */
        ...
        |------------------------------------------------------------
        */
        $this->assertInstanceOf('Addons\Entrust\Tests\Models\Role', $this->role->detachPermissions($perms));
    ...
    public function testDetachAllPermissions()
    {
        ...
        */
        ...
        |------------------------------------------------------------
        */
        $this->assertInstanceOf('Addons\Entrust\Tests\Models\Role', $this->role->detachPermissions());
        $this->assertCount(0, $this->role->permissions()->get()->toArray());
    }
    ...
    public function testSyncPermissions()
    {
        ...
        */
        ...
        |------------------------------------------------------------
        */
        $this->assertInstanceOf('Addons\Entrust\Tests\Models\Role', $this->role->syncPermissions($perms));
        $this->assertCount(2, $this->role->permissions()->get()->toArray());
