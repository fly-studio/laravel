...
class SetupTeamsCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'entrust:setup-teams';
     ...
     * @var string
     */
    protected $migrationSuffix = 'entrust_setup_teams';
    ...
    public function handle()
    {
        if (!Config::get('entrust.use_teams')) {
            $this->error('Not using teams in your Addons\Entrust configuration file.');
        ...
        $this->line('');
        $this->info("The Addons\Entrust teams feature setup is going to add a migration and a model");
    ...
    protected function getExistingMigrationsWarning(array $existingMigrations)
    {
        if (count($existingMigrations) > 1) {
            $base = "Addons\Entrust setup teams migrations already exist.\nFollowing files were found: ";
        } else {
            $base = "Addons\Entrust setup teams migration already exists.\nFollowing file was found: ";
        }
