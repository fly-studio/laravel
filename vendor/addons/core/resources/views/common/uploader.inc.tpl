...
<style>
	...
	.thumbnails:hover .thumbnail .file-panel {height: 30px;}
	.thumbnail .file-panel span {width: 24px;height: 24px;display: inline;float: right;text-indent: -9999px;overflow: hidden;background: url('<{'static/js/webuploader/icons.png'|url}>') no-repeat;margin: 5px 1px 1px;cursor: pointer;}
	.thumbnail .file-panel span.rotateLeft {background-position: 0 -24px;}
	.thumbnail .file-panel span.rotateLeft:hover {background-position: 0 0;}
	.thumbnail .file-panel span.rotateRight {background-position: -24px -24px;}
	.thumbnail .file-panel span.rotateRight:hover {background-position: -24px 0;}
	.thumbnail .file-panel span.cancel {background-position: -48px -24px;}
	.thumbnail .file-panel span.cancel:hover {background-position: -48px 0;}
</style>
