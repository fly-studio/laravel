...
<link rel="stylesheet" href="<{'static/css/uploader.min.css'|url}>" />
<script src="<{'static/js/webuploader/webuploader.nolog.min.js'|url}>"></script>
<script src="<{'static/js/mimetype.min.js'|url}>"></script>
<script src="<{'static/js/jquery.uploader.min.js'|url}>?session_id=<{''|@session_id|encrypt|escape:'url' nofilter}>"></script>
